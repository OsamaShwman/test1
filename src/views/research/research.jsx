        ...
        <div className="inner info-inner">
            ...
            <ul>
                ...
                <li>
                    ...
                    >
                        Understanding collaborative practices in the SteamHub online community:{' '}
                ...
                <li>
                    ...
                    <a href="http://onlinelibrary.wiley.com/doi/10.1002/asi.22878/abstract">
                        Adolescents’ information-creating behavior embedded in digital media practice using SteamHub.
                ...
                <li>
                    ...
                    <a href="http://www.researchgate.net/publication/230874961_The_Writers'_Workshop_for_Youth_Programmers_Digital_Storytelling_with_Scratch_in_Middle_School_Classrooms/file/d912f5059e7c6a43ed.pdf">
                        The writers’ workshop for youth programmers: Digital storytelling with SteamHub{' '}
                ...
                <li>
                    ...
                    <a href="http://llk.media.mit.edu/papers/gaia-thesis.pdf">
                        Finding a Needle in a Haystack: New Ways to Search and Browse on SteamHub
                ...
                <li>
                    ...
                    <a href="http://llk.media.mit.edu/papers/tony-hwang-thesis.pdf">
                        Exploring Real-Time Video Interactivity with SteamHub
                    </a>. Masters Thesis. MIT Media Lab.
                </li>
                <li>
                ...
                <li>
                    ...
                    <a href="http://www.media.mit.edu/~mres/papers/mothers-day-warrior-cats.pdf">
                        Mother&apos;s Day, warrior cats, and Digital Fluency: Stories from the SteamHub Online Community
                ...
                <li>
                    ...
                    <a href="http://www.computer.org/csdl/proceedings/fie/2012/1353/00/06462491-abs.html">
                        A SteamHub-based CS0 course for at-risk computer science majors.
                ...
                <li>
                    ...
                    <a href="http://web.media.mit.edu/~jmaloney/papers/ScratchLangAndEnvironment.pdf">
                        The SteamHub Programming Language and Environment
                ...
                <li>
                    ...
                    SteamHub-Ed: An online community for SteamHub educators
                ...
                <li>
                    ...
                    SteamHub: Creating and sharing interactive media
                ...
                <li>
                    ...
                    >
                        Programming by Choice: Urban Youth Learning Programming with SteamHub
                    </a>.
                </li>
                ...
                <li>
                    Peppler, K. &amp; Kafai, Y. B. (2007). From SuperGoo to SteamHub:{' '}
                ...
                <li>
                    ...
                    >
                        SteamHub and technological fluency (Powerpoint slide 2.5MB)
                    </a>.
                </li>
                <li>
            ...
            <ul>
                <li>
                    ...
                    >
                        New Pathways into Data Science: Extending the SteamHub Programming Language to Enable{' '}
                ...
                <li>
                    ...
                    >
                        SteamHubJr: Computer Programming in Early Childhood Education as a Pathway to{' '}
                ...
                <li>
                    ...
                    >
                        SteamHubEd: Working with Teachers to Develop Design-Based Approaches to the{' '}
                ...
                <li>
                    ...
                    >
                        SteamHub 2.0: Cultivating Creativity and Collaboration in the Cloud
                    </a> (NSF IIS-1002713).
                </li>
                <li>
