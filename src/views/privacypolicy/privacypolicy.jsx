        ...
        <div className="inner info-inner">
            <section>
                <p className="lastupdate">
                    <i>
                        The SteamHub Privacy Policy was last updated: February 14, 2019
                    </i>
                </p>
                <p className="intro">
                SteamHub understands how important privacy is to our
                    community, especially kids and parents. We wrote this
                    Privacy Policy to explain what information we collect
                    through our website (SteamHub.mit.edu) (the &#34;Site&#34;),
                ...
                <p className="callout">
                    If you would like to build projects with SteamHub without
                    submitting any Personal Information to us, you can download
                    the <a href="/download">SteamHub Offline Editor</a>. Projects
                    created in the <a href="/download">SteamHub Offline Editor</a>
                    {' '}are not accessible by the SteamHub Team, and using the
                    offline editor does not disclose any personally identifying
                    information to SteamHub unless you upload these projects to
                    the SteamHub online community.
                </p>
            </section>
            <section id="collection">
                <dl>
                    <span className="nav-spacer" />
                    <h3>What personal information does the SteamHub Team collect about me?</h3>
                    <p>
                    ...
                    <dd>
                        ...
                        you create SteamHub projects (including unshared
                    ...
                    <dd>
                        ...
                        experience some inconvenience in your use of SteamHub.
                    </dd>
                </dl>
            </section>
            <section id="usage">
                <dl>
                    <span className="nav-spacer" />
                    <h3>How does the SteamHub Team use my personal information?</h3>
                    <p />
                    ...
                    <dd>
                        ...
                        SteamHub may also receive additional updates from the
                        SteamHub Foundation, a non-profit that supports SteamHub
                    ...
                    <dd>
                        ...
                        SteamHub. The results of this research are shared with
                    ...
                    <dd>
                        ...
                        SteamHub, including unshared projects, comments, and
                        forum posts.
                    </dd>
                    <dd>
            ...
            <section id="share">
                <span className="nav-spacer" />
                <h3>How Does SteamHub Share my Personal Information?</h3>
                <p>
            ...
            <section id="thirdparties">
                ...
                <p>
                    ...
                    Personal Information by SteamHub. It does not address, and we
            ...
            <section id="rights">
                ...
                <dl>
                    ...
                    <dd>
                        If you want to delete your account, login to SteamHub,
                        ...
                        contact help@SteamHub.mit.edu for assistance.
                    </dd>
                    ...
                    <dd>
                        ...
                        help@SteamHub.mit.edu. Please be aware that, even after
            ...
            <section id="protection">
                <span className="nav-spacer" />
                <h3>How does the SteamHub Team protect my personal information?</h3>
                <p>
                    The SteamHub Team has in place administrative, physical, and
                    technical procedures that are intended to protect the
                    information we collect on the SteamHub website against
                    ...
                    to the SteamHub servers and the data we store on them. However,
            ...
            <section id="transfer">
                ...
                <p>
                SteamHub is based in the United States. Personal Information
            ...
            <section id="help">
                <span className="nav-spacer" />
                <h3>What can I do to help protect privacy on SteamHub?</h3>
                <p>
            ...
            <section id="contact">
                ...
                <h3>Contact Us</h3>
                <p>
                    The Code-to-Learn Foundation d/b/a The SteamHub Foundation is
                    ...
                    help@SteamHub.mit.edu or via mail at:
                </p>
                <p>
                SteamHub Foundation<br />
