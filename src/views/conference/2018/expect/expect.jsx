            ...
            <FlexRow className="uneven">
                <div className="short">
                    ...
                    <p>
                        ...
                        <br />
                        Founder, MIT SteamHub Team
                        <br />
                        MIT Media Lab
                    </p>
                </div>
                <div className="long">
                    <h2>Welcome to SteamHub@MIT 2018!</h2>
                    <p className="intro">
                        The theme of this year’s SteamHub conference is “The Next{' '}
                        Generation”. In choosing this phrase, we had two different{' '}
                        meanings in mind.
                    </p>
                    <p className="intro">
                        The theme is motivated, in part, by our work on the next generation{' '}
                        of SteamHub. We plan to release this new version, called SteamHub 3.0,{' '}
                        later this year. SteamHub 3.0 will expand how, what, and where children{' '}
                        can create and learn with SteamHub. At the conference, you’ll have lots{' '}
                    ...
                    <p className="intro">
                        ...
                        children around the world are creating and collaborating with SteamHub.{' '}
                        As we see the outpouring of creativity in the SteamHub community, we{' '}
                        become even more committed to developing a next generation of SteamHub{' '}
                        that is truly worthy of the next generation of children.
                    </p>
                    <p className="intro">
                        At this summer’s SteamHub conference, we look forward to hearing{' '}
                        your stories of how children are creating and learning with SteamHub,{' '}
            ...
            <div className="inner">
                ...
                <FlexRow>
                    <div className="card">
                        ...
                        <img
                            alt="SteamHub Team Photo"
                            src="/images/conference/expect/scratch-team.jpg"
                        />
                        <p>
                            <b>MIT SteamHub Team</b>
                            <br />
                            <b>Mitchel Resnick (moderator)</b>
                        </p>
                        <p>
                            Join us for an inside look at the next generation of SteamHub &mdash;{' '}
                            and a discussion of how SteamHub is opening new opportunities for the next{' '}
                    ...
                    <div className="card">
                        ...
                        <h3>Growing Up With SteamHub</h3>
                        <img
                        ...
                        <p>
                            What is it like to grow up with SteamHub? Three long-time SteamHub community{' '}
                            members share how they have used SteamHub to express their interests, to make{' '}
