    ...
    <div className="expect">
        ...
        <section className="inner profile">
            <FlexRow className="uneven">
                ...
                <div className="long">
                    <h2>Welcome to SteamHub 2016!</h2>
                    <p className="intro">
                        The SteamHub community keeps growing and growing.{' '}
                        Young people around the world have shared more than{' '}
                        15 million projects in the SteamHub online community{' '}
                        – with 20,000 new projects every day.
                    </p>
                    <p className="intro">
                        But what excites us most is not the number of projects{' '}
                        but the diversity of projects. Take a look at the SteamHub{' '}
                    ...
                    <p className="intro">
                        ...
                        members of the SteamHub community are developing their own{' '}
                        voices and identities through SteamHub. They are learning{' '}
                        to express themselves creatively, to build on their interests,{' '}
                        and to share their ideas with others.
                    </p>
                    <p className="intro">
                        At this year’s SteamHub@MIT conference, we’ll celebrate the many{' '}
                        paths and many styles of SteamHub, exploring the multiple ways{' '}
                        that people can create, share, and learn with SteamHub.
                    </p>
                    <p className="intro">
            ...
            <div className="inner">
                ...
                <FlexRow>
                    <div className="card">
                        ...
                        <p>
                            The MIT SteamHub Team opens the conference with a series of{' '}
                            conversations, exploring new ideas, new directions, and new{' '}
                            strategies for supporting creative learning with SteamHub.
                        </p>
                    </div>
                    <div className="card">
                        <div className="date">
