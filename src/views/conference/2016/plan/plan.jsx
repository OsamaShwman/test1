            ...
            <div className="plan">
                ...
                <div className="inner">
                    ...
                    <section className="explore">
                        ...
                        <div>
                            <p>
                                Try some SteamHub Team favorites for snacking and dining around the Lab:
                            </p>
                            <ul>
                                <li>
                                    A4 Pizza
                        ...
                        <FlexRow className="uneven">
                            <div className="long">
                                ...
                                <dl>
                                    ...
                                    <dd>
                                        SteamHub@MIT is sold out and at capacity. Regrettably, we are{' '}
                                        unable to add any additional guests. Please keep in mind that{' '}
                                        you must have registered on Eventbrite to attend SteamHub@MIT;{' '}
                                    ...
                                    <dd>
                                        The SteamHub Conference is a gathering of adult educators, developers,{' '}
                                    ...
                                    <dd>
                                        Yes. Contact us at conference@SteamHub.mit.edu and we can email you a letter.
                                    </dd>
                                    ...
                                    <dd>
                                        Contact us at a conference@SteamHub.mit.edu with your registration number,{' '}
